...
# this scenario. This is because in a singly-linked list, the time complexity of the enqueue and dequeue 
# operations are O(1) compared to that of an ArrayQueue which has a complxity of O(n) when adding a new 
# element at the head.
